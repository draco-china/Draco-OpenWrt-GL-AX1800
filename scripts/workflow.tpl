...
name: Build ${deviceUpper} OpenWrt
  ...
  build:
    ...
    - name: Download package
      ...
      run: |
        ...
        ./scripts/gen_config.py glinet-${device} glinet_depends
    ...
    - name: Generate release tag
      ...
      run: |
        echo "::set-output name=release_tag::${deviceUpper}-$(date +"%Y.%m.%d-%H.%M")"
        touch release.txt
        echo "${deviceUpper}固件" >> release.txt
